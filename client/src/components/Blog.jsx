                  ...
                  <Wrapper key={cur._id}>
                     <Box>
                        ...
                        <Box style={{display:"flex",gap:"20px"}}>
                            <Typography style={{fontSize:"13px"}}>{reducestr(cur.createdDate)}</Typography>
                            <Typography style={{fontSize:"13px"}}>{cnt} min read</Typography>
                            <Typography style={{fontSize:"13px",backgroundColor:"#F2F2F2",border:"1px solid #F2F2F2",color:"#6B6B6B"}}>{cur.categories}</Typography>
                        </Box>
                        </Link>
                     </Box>
